  ...
  return (
    <nav className="navbar">
      ...
      <ul className="navbar-list">
        <li><button onClick={() => setActiveSection('book')}>Book Appointment</button></li>
        <li><button onClick={() => setActiveSection('myAppointments')}>My Appointments</button></li>
        <li><button onClick={() => setActiveSection('medicalHistory')}>Medical History</button></li>
